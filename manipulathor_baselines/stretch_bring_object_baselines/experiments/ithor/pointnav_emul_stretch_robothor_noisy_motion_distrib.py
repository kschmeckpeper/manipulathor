...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_noisy_motion \
    import PointNavEmulStretchRobothorNoisyMotion


class PointNavEmulStretchRobothorNoisyMotionDistrib(
    PointNavEmulStretchRobothorNoisyMotion
):
    NUM_PROCESSES = 8
    def __init__(
            self,
