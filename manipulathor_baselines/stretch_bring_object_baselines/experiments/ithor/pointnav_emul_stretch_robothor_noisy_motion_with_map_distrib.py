...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_noisy_motion_with_map \
    import PointNavEmulStretchRobothorNoisyMotionWithMap


class PointNavEmulStretchRobothorNoisyMotionWithMapDistrib(
    PointNavEmulStretchRobothorNoisyMotionWithMap
):
    NUM_PROCESSES = 8
    def __init__(
            self,
