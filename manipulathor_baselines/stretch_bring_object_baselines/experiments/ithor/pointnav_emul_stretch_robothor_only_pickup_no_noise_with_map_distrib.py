...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_only_pickup_no_noise_with_map \
    import PointNavEmulStretchRobothorOnlyPickupNoNoiseWithMap


class PointNavEmulStretchRobothorOnlyPickupNoNoiseWithMapDistrib(
    PointNavEmulStretchRobothorOnlyPickupNoNoiseWithMap
):
    NUM_PROCESSES = 8
    def __init__(
            self,
