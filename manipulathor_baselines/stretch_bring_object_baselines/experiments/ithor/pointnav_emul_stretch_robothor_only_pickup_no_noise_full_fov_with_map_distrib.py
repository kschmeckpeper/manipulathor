...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_only_pickup_no_noise_full_fov_with_map \
    import PointNavEmulStretchRobothorOnlyPickupNoNoiseFullFovWithMap


class PointNavEmulStretchRobothorOnlyPickupNoNoiseFullFovWithMapDistrib(
    PointNavEmulStretchRobothorOnlyPickupNoNoiseFullFovWithMap
):
    NUM_PROCESSES = 8
    def __init__(
            self,
