...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_noisy_motion_noisy_pose_10_with_map \
    import PointNavEmulStretchAllRoomsNoisyMotionNoisyPoseWithMap10


class PointNavEmulStretchAllRoomsNoisyMotionNoisyPoseWithMap10Distrib(
    PointNavEmulStretchAllRoomsNoisyMotionNoisyPoseWithMap10
):
    NUM_PROCESSES = 8
    def __init__(
            self,
