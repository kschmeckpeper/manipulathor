...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_noisy_motion_with_map_curr_obj \
    import PointNavEmulStretchRobothorNoisyMotionWithMapCurrObj


class PointNavEmulStretchRobothorNoisyMotionWithMapCurrObjDistrib(
    PointNavEmulStretchRobothorNoisyMotionWithMapCurrObj
):
    NUM_PROCESSES = 8
    def __init__(
            self,
