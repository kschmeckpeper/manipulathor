...
class PointNavEmulStretchRobothorNoisyMotionWithMapCurrObj(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchRobothorNoisyMotionWithMapCurrObj, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchRobothorNoisyMotionWithMapCurrObj, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return StretchObjectDisplacementMapModel(
            ...
            hidden_size=512,
            only_encode_current_object_map=True,
