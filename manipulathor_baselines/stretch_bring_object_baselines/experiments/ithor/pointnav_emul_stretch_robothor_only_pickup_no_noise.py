...
class PointNavEmulStretchRobothorOnlyPickupNoNoise(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchRobothorOnlyPickupNoNoise, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchRobothorOnlyPickupNoNoise, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
