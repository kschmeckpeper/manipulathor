...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_noisy_motion_noisy_pose \
    import PointNavEmulStretchAllRoomsNoisyMotionNoisyPose


class PointNavEmulStretchAllRoomsNoisyMotionNoisyPoseDistrib(
    PointNavEmulStretchAllRoomsNoisyMotionNoisyPose
):
    NUM_PROCESSES = 8
    def __init__(
            self,
