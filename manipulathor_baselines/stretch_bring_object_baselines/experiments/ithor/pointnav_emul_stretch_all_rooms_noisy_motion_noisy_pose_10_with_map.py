...
class PointNavEmulStretchAllRoomsNoisyMotionNoisyPose10WithMap(
    StretchBringObjectiThorBaseConfig,
    StretchBringObjectMixInPPOConfig,
    StretchBringObjectMixInSimpleGRUConfig,
):
    ...
    odometry_sensor = AgentOdometryEmulSensor(pos_noise=0.10)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionNoisyPose10WithMap, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(PointNavEmulStretchAllRoomsNoisyMotionNoisyPose10WithMap, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
