...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_all_rooms_noisy_motion_noisy_pose_20 \
    import PointNavEmulStretchAllRoomsNoisyMotionNoisyPose20


class PointNavEmulStretchAllRoomsNoisyMotionNoisyPose20Distrib(
    PointNavEmulStretchAllRoomsNoisyMotionNoisyPose20
):
    NUM_PROCESSES = 8
    def __init__(
            self,
