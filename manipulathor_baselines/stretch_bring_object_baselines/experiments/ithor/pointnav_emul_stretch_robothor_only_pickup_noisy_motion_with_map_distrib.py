...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_only_pickup_noisy_motion_with_map \
    import PointNavEmulStretchRobothorOnlyPickupNoisyMotionWithMap


class PointNavEmulStretchRobothorOnlyPickupNoisyMotionWithMapDistrib(
    PointNavEmulStretchRobothorOnlyPickupNoisyMotionWithMap
):
    NUM_PROCESSES = 8
    def __init__(
            self,
