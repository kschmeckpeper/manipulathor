...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_only_pickup_noisy_motion \
    import PointNavEmulStretchRobothorOnlyPickupNoisyMotion


class PointNavEmulStretchRobothorOnlyPickupNoisyMotionDistrib(
    PointNavEmulStretchRobothorOnlyPickupNoisyMotion
):
    NUM_PROCESSES = 8
    def __init__(
            self,
