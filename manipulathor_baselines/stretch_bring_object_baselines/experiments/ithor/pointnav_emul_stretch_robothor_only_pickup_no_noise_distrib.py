...
from manipulathor_baselines.stretch_bring_object_baselines.experiments.ithor.pointnav_emul_stretch_robothor_only_pickup_no_noise \
    import PointNavEmulStretchRobothorOnlyPickupNoNoise


class PointNavEmulStretchRobothorOnlyPickupNoNoiseDistrib(
    PointNavEmulStretchRobothorOnlyPickupNoNoise
):
    NUM_PROCESSES = 8
    def __init__(
            self,
